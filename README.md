...
# Name: LOGESHWARI R(212223060137)
## AIM:
...
<img width="951" height="700" alt="image" src="https://github.com/user-attachments/assets/1ae71f95-5983-480e-b42e-6f80400e338c" />



## Prompt 2 : Explain Ohm’s Law in simple words.
<img width="894" height="509" alt="image" src="https://github.com/user-attachments/assets/994ea18c-365a-42f3-977d-65a79e4207cb" />
...
## Prompt 1:
## Example 1:
Input: Write a short paragraph on the importance of honesty. Output: Honesty is important because it builds trust between people. When we are honest, others believe in us and respect us.

## Example 2:
Input: Write a short paragraph on the importance of time management. Output: Time management helps us stay organized and complete tasks on time. It reduces stress and improves success.
...
## Prompt 2:
## Example 1:
Input: Explain Newton’s First Law in simple words. Output: Newton’s First Law says that an object will stay at rest or keep moving unless an outside force acts on it.

## Example 2:
Input: Explain Hooke’s Law in simple words. Output: Hooke’s Law says that the more you stretch a spring, the more it pulls back.
...
<img width="1301" height="553" alt="image" src="https://github.com/user-attachments/assets/0f07510a-b9b9-4a27-b0a1-9eb4dabe05dc" />
